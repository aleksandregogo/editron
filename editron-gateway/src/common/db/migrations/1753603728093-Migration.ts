...
export class Migration1753603728093 implements MigrationInterface {
    name = 'Migration1753603728093'

    public async up(queryRunner: QueryRunner): Promise<void> {
        // Enable pgvector extension for vector similarity search
        await queryRunner.query(`CREATE EXTENSION IF NOT EXISTS vector`);
        
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "email" character varying, "name" character varying NOT NULL, "personal_number" character varying, "profile_picture" character varying, "google_id" character varying, "facebook_id" character varying, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_0bd5012aeb82628e07f6a1be53b" UNIQUE ("google_id"), CONSTRAINT "UQ_df199bc6e53abe32d64bbcf2110" UNIQUE ("facebook_id"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_knowledge_items_embedding" ON "knowledge_items" USING ivfflat (embedding vector_cosine_ops) WITH (lists = 100)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_knowledge_items_embedding"`);
